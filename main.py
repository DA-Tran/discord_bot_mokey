...
mtg [card name] - Search for Magic: The Gathering cards
========================
...
mcreboot - Reboots the server
========================
***Stock Market Commands***
apistatus - Check current API usage and rate limit status
stock [ticker] - Get real-time stock information (e.g., stock AAPL)
stocksearch [company name] - Search for stocks by company name
========================
***Music***
